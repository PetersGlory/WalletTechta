    ...
    <SafeAreaView style={{
      ...
      <ScrollView style={tw`h-full w-full ${Platform.OS == "ios" ? "p-5 pt-15" : "" }`}>
        <TouchableOpacity style={tw`w-12 p-2 border border-gray-400 rounded-lg`} onPress={()=>navigation.goBack()}>
            <Icon name='md-chevron-back' color={PrimaryColor} size={26} />
        </TouchableOpacity>
        ...
        <View style={tw`mt-[30px]`}>
            ...
            <Text style={tw`text-gray-400 text-[14px] mt-[8px]`}>Welcome to Wallet Techta, Sign in to your account</Text>
        </View>
        ...
        <View style={tw`mt-3 w-full flex flex-col items-center pt-5`}>
            ...
            {isBiometricSupported && fingerprint ? (                
                <TouchableOpacity onPress={fingerPrintAuth} style={tw`w-full mt-2 p-4 items-center rounded-2xl`}>
                    <Icon name='md-finger-print-outline' size={30} color={PrimaryColor} />
                </TouchableOpacity>
            ) : (
                <View>
